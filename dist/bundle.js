...
/******/ 	var hotCurrentHash = "e6b07e08a2c774f8d267"; // eslint-disable-line no-unused-vars
...
/***/ function(module, exports, __webpack_require__) {
	...
	function main(responses) {
	  ...
	  var requests = {
	    DOM: responses.DOM.select('.classe').events('input').map(function (ev) {
	      return ev.target.value;
	    }).startWith('').map(function (name) {
	      return (0, _dom.h)('div', [(0, _dom.h)('label', 'Name:'), (0, _dom.h)('input.clase', { attributes: { type: 'text' } }), (0, _dom.h)('h1', 'O Hai ' + name)]);
	    })
	  };
